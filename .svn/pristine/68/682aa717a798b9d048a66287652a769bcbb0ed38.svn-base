...
public class StolenVehicleActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupHeaderView();
        setup();
        new GoogleAnalyticsUtil().trackScreens(IndriveApplication.getInstance(),getResources().getString(R.string.screen_stolen));
    }
    ...
    private void setup() {
        ...
        tv.setText( Html.fromHtml(getString(R.string.stolen_vehicle_text_1)
                        ...
                        +" <a href='tel:"+getString(R.string.stolen_vehicle_contact_number) + "'>"
                        + getString(R.string.stolen_vehicle_contact_number) + "</a> "
