...
//        String imageId = getUpSellImageId(moduleName);
    ...
    public static UpSellData getUpSellData(String moduleName, Context context) {
        if (moduleName == null)
            return null;
        UpSellData upSellData = new UpSellData();
        if (moduleName.equalsIgnoreCase("diagnosticsAlert")) {
            upSellData.setHeader(context.getResources().getString(R.string.about_diagnostics_alerts));
            upSellData.setMessage(context.getResources().getString(R.string.vehicle_health_upsell_text));
            upSellData.setImageId(R.drawable.alerts_background);
        } else if (moduleName.equalsIgnoreCase("speedAlert")) {
            upSellData.setHeader(context.getResources().getString(R.string.about_speed_alert));
            upSellData.setMessage(context.getResources().getString(R.string.speed_alert_upsell_text));
            upSellData.setImageId(R.drawable.alerts_background);
        } else if (moduleName.equalsIgnoreCase("locationAlert")) {
            upSellData.setHeader(context.getResources().getString(R.string.about_boundary_alerts));
            upSellData.setMessage(context.getResources().getString(R.string.location_services_upsell_text));
            upSellData.setImageId(R.drawable.alerts_background);
        } else if (moduleName.equalsIgnoreCase("LocateVehicle")) {
            upSellData.setHeader(context.getResources().getString(R.string.vehicle_location_services_header));
            upSellData.setMessage(context.getResources().getString(R.string.locateVehicle_services_upsell_text));
            upSellData.setImageId(R.drawable.location_background);
        }else if (moduleName.equalsIgnoreCase("LocationAlerts")) {
            upSellData.setHeader(context.getResources().getString(R.string.vehicle_location_services_header));
            upSellData.setMessage(context.getResources().getString(R.string.location_services_upsell_text));
            upSellData.setImageId(R.drawable.location_background);
        }else if (moduleName.equalsIgnoreCase("LocationHistory")) {
            upSellData.setHeader(context.getResources().getString(R.string.vehicle_location_services_header));
            upSellData.setMessage(context.getResources().getString(R.string.locationHistory_services_upsell_text));
            upSellData.setImageId(R.drawable.location_background);
        }else if (moduleName.equalsIgnoreCase("vehicleHealthShowServiceNotEnabled") || moduleName.equalsIgnoreCase("maintenanceRemaindersView")
               || moduleName.equalsIgnoreCase("maintenanceLogsView") || moduleName.equalsIgnoreCase("recallInformationCurrentAndCompleted")
                || moduleName.equalsIgnoreCase("vehicleHealthDiagnosticsDetailsPage")
                ) {
            upSellData.setHeader(context.getResources().getString(R.string.about_diagnostics));
            upSellData.setMessage(context.getResources().getString(R.string.vehicle_health_upsell_text));
            upSellData.setImageId(R.drawable.menu_background);
        }
