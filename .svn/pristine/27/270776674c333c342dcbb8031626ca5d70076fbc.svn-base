...
public class MenuHomeActivity extends BaseFragmentActivity {
    private static final String TAG = MenuHomeActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRelativeLayoutNavigation.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        logOutTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(AppController.instance().getStayLoggedSetting())
                   AppController.instance().setStayLoggedSetting(false);
    ...
    private void setUpActionBar() {
        ...
        mActionBar.setIcon(R.color.trans);
    }
                ...
                case 1:
                    ...
                    if(!AppController.instance().getAccountStatus().equalsIgnoreCase("Inactive"))
                      launchActivity(AppSettingsActivity.class);
                       ...
                       Toast.makeText(MenuHomeActivity.this,getResources().getString(R.string.account_status_inactive),Toast.LENGTH_LONG).show();
                    break;
                case 2:
                    //Premium Services
                    mDrawerLayout.closeDrawers();
