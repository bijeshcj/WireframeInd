...
public class ProfileAdapter extends BaseAdapter {
    ...
    public ProfileAdapter(Context context, int mType, ArrayList<UserInfo> options) {
    ...
    public Object getItem(int position) {
        ...
        if (mType == PROFILE_HEADER) {
            ...
            return mOptionsDesc.get(position);
        }
    }
    ...
    private void initOptions() {
       /* mOptions.add(new UserInfo("Joe Greene","Name"));
        ...
        //Commenting the below two functionality as per the comments from Lori
