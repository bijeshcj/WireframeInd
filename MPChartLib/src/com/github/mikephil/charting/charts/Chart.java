...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends View
    ...
    protected boolean noChartEntryForWeek;
...
//    private String mNoDataText = "No driving data available at this time. Please check back later";
    ...
    public void setNoChartEntryForWeek(boolean flag){
        noChartEntryForWeek = flag;
    }
    ...
    protected void init() {
        ...
        mInfoPaint.setTextSize(Utils.convertDpToPixel(10f));
