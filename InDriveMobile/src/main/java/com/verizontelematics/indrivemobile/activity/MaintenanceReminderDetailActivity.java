...
public class MaintenanceReminderDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parseArguments();
        setupUI();
        new GoogleAnalyticsUtil().trackScreens(IndriveApplication.getInstance(),getResources().getString(R.string.screen_edit_rem));
    }
...
//        headerRL.setBackgroundColor(this.getResources().getColor(R.color.diagnostics_code));
    ...
    private void setupUI() {
        ...
        if (mUserSelection.equals(AppConstants.USER_SELECTION.MILEAGE)) {
            ...
            mileageTV.setText(Html.fromHtml("<b>" + getResources().getString(R.string.mileage_interval) + " : </b>" + String.valueOf(mMaintenanceReminderData.getReminderConfigMiles())+" miles"));

        } else {
            // Alert Date
            dateLL.setVisibility(View.VISIBLE);
            mileageTV.setVisibility(View.GONE);
            @SuppressLint("SimpleDateFormat") SimpleDateFormat mFormatter = new SimpleDateFormat("M/dd/yyyy");
            ...
            long inter = mMaintenanceReminderData.getReminderConfigMonths();
            String s = "";
            if(inter > 1)
                s = mMaintenanceReminderData.getReminderConfigMonths() +" months";
            else
                s = mMaintenanceReminderData.getReminderConfigMonths() +" month";
            frequencyTV.setText(Html.fromHtml("<b>" + getResources().getString(R.string.repeat) + " : </b>" + s));
