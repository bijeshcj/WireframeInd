...
/**
 * Created by prokarma on 3/30/2015.
 */
public class CustomizedTimePicker extends FrameLayout {

    private static final String TAG = CustomizedTimePicker.class.getCanonicalName();
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(CustomizedTimePicker view, int hourOfDay, int minute);
    }

    public CustomizedTimePicker(Context context) {
        this(context, null);
        mContext = context;
    }

    public CustomizedTimePicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        mContext = context;
    }

    public CustomizedTimePicker(Context context, AttributeSet attrs, int defStyle) {
...
//        setContentDescriptions();
    ...
    private void initPickerCalendar(){
        pickerCalendar = Calendar.getInstance();
        pickerCalendar.set(Calendar.HOUR_OF_DAY, getCurrentHour());
        pickerCalendar.set(Calendar.MINUTE, getCurrentMinute());
    }
...
//        mDivider.setText(separatorText);
    ...
    private void updateHourControl() {
        ...
        mHourSpinner.setFormatter(mHourWithTwoDigit ? TWO_DIGIT_FORMATTER : null);
    }
   ...
   private void updateMinuteControl() {
    ...
    private void updateAmPmControl() {
        if (is24HourView()) {
            if (mAmPmSpinner != null) {
             ...
             index = mIsAm ? Calendar.AM : Calendar.PM;
            if (mAmPmSpinner != null) {
                mAmPmSpinner.setValue(getAmPmSpinnerValue(index));
    ...
    private int getAmPmSpinnerValue(int index){
...
//            setCurrentHour(5);
    ...
    private void onTimeChanged() {
        Log.d(TAG,"timepicker onTimeChanged");
        sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_SELECTED);
