 ...
 */
@Deprecated
public class CustomTimePicker1 extends FrameLayout {
    ...
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
        public void onTimeChanged(CustomTimePicker1 view, int hourOfDay, int minute, int periodOfDay) {
        }
    };
...
//    private final NumberPicker mAmPmPicker;
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(CustomTimePicker1 view, int hourOfDay, int minute, int periodOfDay);
    }
    ...
    public CustomTimePicker1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomTimePicker1(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*mAmPmPicker = (NumberPicker)findViewById(R.id.amPmSpinner);
        mAmPmPicker.setMinValue(0);
        mAmPmPicker.setMaxValue(1);
        mAmPmPicker.setDisplayedValues(new String[]{"AM","PM"});
...
//        setCurrentSecond(cal.get(Calendar.SECOND));
        ...
        String mAmText = dfsAmPm[Calendar.AM];
        String mPmText = dfsAmPm[Calendar.PM];
...
//        mAmPmButton.setEnabled(enabled);
    ...
    /**
     * get the current period of the day am/pm
     * @return
     */
    public Integer getCurrentPeriodOfDay(){
        return this.mPeriodValue;
    }

    /**
     * set the current period of the day am/pm
     * @param amPm
     */
    public void setCurrentPeriodOfDay(int amPm){
        this.mPeriodValue = amPm;
        updateCurrentPeriodOfDay();
    }
    ...
    private void updateHourDisplay() {
        ...
        if (!mIs24HourView) {
            ...
            if (currentHour > 12) {
                currentHour -= 12;
                mPeriodValue = 1;
//                mAmPmPicker.setValue(mPeriodValue);
            }
...
//            mAmPmButton.setVisibility(View.VISIBLE);
    ...
    private void onTimeChanged() {
        mOnTimeChangedListener.onTimeChanged(this, getCurrentHour(), getCurrentMinute(), getCurrentPeriodOfDay());
    }
    ...
    private void updateCurrentPeriodOfDay(){
//        mAmPmPicker.setValue(mPeriodValue);
    }
