...
//            String signed_cert = InDrivePreference.getInstance().getStringData("cert", "");
            String signed_cert = Base64Util.decodeBase64AsString(FileUtils.readCertFromAppInternal(IndriveApplication.getInstance()));
