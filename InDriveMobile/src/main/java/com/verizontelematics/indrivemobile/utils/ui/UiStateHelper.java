...
public class UiStateHelper {
    ...
    public static int getListTitleSize(Context context) {
        int displayMetrics = context.getResources().getDisplayMetrics().densityDpi;
        int height = (int) context.getResources().getDimension(R.dimen.header_hdpi_size);
        switch (displayMetrics) {
            case DisplayMetrics.DENSITY_LOW:
            ...
            case DisplayMetrics.DENSITY_XXHIGH:
                ...
                break;
            case DisplayMetrics.DENSITY_XXXHIGH:
                height = (int) context.getResources().getDimension(R.dimen.dashboard_list_xxxhdpi_header_size);
                break;
            default:
                break;
    ...
    public static int getListSubTitleSize(Context context) {
        int displayMetrics = context.getResources().getDisplayMetrics().densityDpi;
        int height = (int) context.getResources().getDimension(R.dimen.sub_item_hdpi_size);
        switch (displayMetrics) {
            case DisplayMetrics.DENSITY_LOW:
            ...
            case DisplayMetrics.DENSITY_XXHIGH:
                ...
                break;
            case DisplayMetrics.DENSITY_XXXHIGH:
                height = (int) context.getResources().getDimension(R.dimen.dashboard_sub_list_xxxhdpi_header_size);
                break;
            default:
                break;
